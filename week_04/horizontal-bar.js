...
d3.csv("covid.csv").then((data) => {
  ...
  // ranking large number of case to small (Descending)
  // When sort() compares two values, it sends the values to the compare function,
  //and sorts the values according to the returned (negative, zero, positive) value.
  // Ascending data.sort((a, b) => a.cases - b.cases);

  data.sort((a, b) => d3.ascending(a.country, b.country)); // alphabetical order of country
